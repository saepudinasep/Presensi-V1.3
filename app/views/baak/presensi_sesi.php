                ...
                <main>
                    <div class="container-fluid px-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2 mt-4">Presensi <?= $data['mk']['nama_mk']; ?></h1>
                        </div>
                                    ...
                                    <tbody>
                                        <?php foreach($data['sesi'] as $index => $sesi) : ?>
                                            <tr>
                                                <td><?= $index+1; ?>.</td>
                                                <td>
                                                    <a href="<?= BASEURL; ?>?url=Data_presensi_mhs/data_viewPresensiMhs/<?= $sesi['id_mk_sesi']; ?>" style="text-decoration: none;">
                                                        <?= $sesi['nama_mk_sesi']; ?>
                                                    </a>
                                                </td>
                                                <td><?= $sesi['nama_dosen']; ?></td>
                                                <td>
