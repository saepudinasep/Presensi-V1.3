            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2 mt-4">Mata Kuliah <?= $data['kelas']['kode_kelas']; ?></h1>
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Mata Kuliah <?= $data['kelas']['kode_kelas']; ?></li>
                        </ol>
                        <div class="card mb-4">
                            <?php Flasher::flash(); ?>
                        </div>
                                    ...
                                    <tbody>
                                        <?php foreach($data['mk'] as $index => $mk) : ?>
                                            <tr>
                                                <td><?= $index+1; ?>.</td>
                                                <td>
                                                    <a href="<?= BASEURL; ?>?url=Data_presensi_mhs/presensi_sesiMk/<?= $mk['id_mk']; ?>" style="text-decoration: none;">
                                                        <?= $mk['nama_mk']; ?>
                                                    </a>
                                                </td>
                                                <td>
