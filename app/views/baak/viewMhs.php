            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        ...
                        <div class="row mb-4 justify-content-end">
                            <div class="col-md-6">
                                <a href="<?= BASEURL; ?>?url=Data_mhs/data_jadwal" class="btn btn-success">Jadwal Kuliah</a>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Data Mahasiswa 
                                <a href="" class="btn btn-primary tombolTambahMhs" data-bs-toggle="modal" data-bs-target="#formMhs" style="text-decoration: none;">
  ...
  <div id="modal-size" class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?= BASEURL; ?>?url=Data_mhs/tambahMhs" method="post">
          <input type="hidden" name="id" id="id">
            ...
            <div class="mb-3">
                ...
                <input class="form-check-input" type="radio" value="P" name="jk" id="jkp" checked>
...
<script>
    $(function () {
        //start modal tombolTambahMhs
        $('.tombolTambahMhs').on('click', function() {
            $('.modal-title').html('Tambah Data Mahasiswa');
            $('.modal-footer button[type=submit]').html('Tambah');
            $('.modal-body form').attr('action', '<?= BASEURL; ?>?url=Data_mhs/tambahMhs');
