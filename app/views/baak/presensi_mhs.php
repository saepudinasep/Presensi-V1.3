                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="<?= BASEURL; ?>?url=Baak/data_akademik" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2 mt-4">Data Kelas <?= $data['kelas']['kode_kelas']; ?></h1>
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="<?= BASEURL; ?>?url=Data_presensi_mhs/presensi_kelas/<?= $data['prodi_1']['id_prodi']; ?>">Prodi <?= $data['prodi_1']['nama_prodi']; ?></a></li>
                            <li class="breadcrumb-item"><a href="<?= BASEURL; ?>?url=Data_presensi_mhs/presensi_mk_mhs/<?= $data['kelas']['id_kelas']; ?>"><?= $data['kelas']['kode_kelas']; ?></a></li>
                            <li class="breadcrumb-item"><a href="<?= BASEURL; ?>?url=Data_presensi_mhs/presensi_sesiMk/<?= $data['mk']['id_mk']; ?>"><?= $data['mk']['nama_mk']; ?></a></li>
                            <li class="breadcrumb-item active"><?= $data['sesi']['nama_mk_sesi']; ?></li>
                        </ol>
                        <div class="card mb-4">
                            <?php Flasher::flash(); ?>
                        </div>
                                        ...
                                        <?php foreach($data['mhs'] as $index => $mhs) : ?>
                                            <tr>
                                                ...
                                                <?php foreach($data['presensi'] as  $presensi) : ?>
                                                    <?php
                                                    if ($presensi['username']==$mhs['username']){
                                                        echo "HADIR";
                                                    }
                                                    ?>
                                                <?php endforeach; ?>
